    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-purple-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Loanee Portal</h1>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                disabled={isLoading}
              >
                {isLoading ? "Signing in..." : "Sign In as Loanee"}
              </Button>
            </form>
          </CardContent>
